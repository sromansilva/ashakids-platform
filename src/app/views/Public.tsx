...
export function PublicNav({ go, cur }: { go: (v: View) => void; cur: View }) {
  ...
  const links: { label: string; view: View }[] = [
    ...
    { label: "Planes",         view: "public/planes" },
  ];
...
export function PublicFooter({ go }: { go: (v: View) => void }) {
  const cols = [
    ...
    { title: "Soporte",     links: [{ l: "Centro de Ayuda", v: "public/ayuda" as View }, { l: "Contacto", v: "public/contacto" as View }, { l: "Planes y Precios", v: "public/planes" as View }] },
  ];
  return (
